...
For the decomposition problem for \DFAs this is as good as it gets, but since we actually want to decompose labels, we will focus on the or-decomposition and finding decompositions with different properties than minimal width.
%%% Local Variables: 
%%% mode: latex
%%% TeX-master: "thesis"
%%% End: 