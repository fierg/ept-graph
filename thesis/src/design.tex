...
\begin{figure}[h]
	...
	\begin{minipage}[t]{0.49\textwidth}
		...
		\begin{tikzpicture}[every edge quotes/.style = {auto, font=\footnotesize, sloped}]
			...
			(B) edge["100"] (C)
			(D) edge[bend right, below,"0010"] (C)
