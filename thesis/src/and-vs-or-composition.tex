...
As we defined the \orDecomp with $L(A) = \cup_{1\leq i \leq k} L(B_i)$ as a conceptual counterpart to the \andDecomp, we considered different \DFAs with either a \andDecomp or an \orDecomp.
