...
\begin{proof}
	Since an \andDecomp covers the non final states and an \orDecomp covers the final states, an \andDecomp of the complement of a \DFA will cover its final states, exactly like an \orDecomp and vice versa.
\end{proof}
