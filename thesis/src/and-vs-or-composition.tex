...
To prove that there exists words which are and-decomposable but not or-decomposable and vice versa, we need a bit of background. For this purpose we have extended the logic operators $\lor$ and $\land$ to binary words such that $a = b \lor c \implies a[i] = b[i] \lor c[i]$.
