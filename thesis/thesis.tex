...
%%
%
% Zum Erstellen zweiseitiger PDFs (für Buchdruck) in der Datei "wissdoc.cls" folgende Zeile gabändern:
%
...
\newcommand{\andDecomp}{AND-decomposition\xspace}
\newcommand{\orDecomp}{OR-decomposition\xspace}
...
\include{src/preliminaries}  % Grundlagen
\include{src/decomposition}     % Analyse
\include{src/and-vs-or-composition}    % and vs or composition
\include{src/explainability}   % explainability
\include{src/novel-algo}     % Entwurf
\include{src/implement} 	% implementation
\include{src/eval}        % Evaluation
\include{src/discussion}   	  % Diskussion und Ausblick
