...
class ChartGenerator {
    ...
    fun generatePlots() {
        ...
        CompositionMode.values().filter { it == CompositionMode.OR }.forEach { compositionMode ->
            DecompositionMode.values().filter { it == DecompositionMode.FOURIER_TRANSFORM }.forEach { decompositionMode ->
