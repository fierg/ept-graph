...
fun main(args: Array<String>){
    ...
    val check by parser.option(ArgType.Boolean, description = "Check array for changes every time, befor a period is applied", shortName = "c").default(false)
    ...
    Decomposition(state, check).findComposite(f2fGraph)
