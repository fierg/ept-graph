...
class ArgParser {
    companion object {
        fun readArgs(args: Array<String>): Options {
            ...
            return Options(dotenv, input, decompositionMode, compositionMode, skipSelfEdges, debug, quiet, deltaWindowPreprocessing, deltaWindowAlgo, threshold, allowFullSizeDecomposition)
        }
    }
}